    ...
    <section class="main">
        <div class="container">
            <article class="content">
                <h1>TP.HCM sẽ tiếp tục giãn cách theo Chỉ thị 16 sau ngày 15-8</h1>
                <p>Trả lời câu hỏi này, ông Phan Văn Mãi, Phó Bí thư Thường trực Thành ủy TP.HCM, cho biết về kết quả trong 2 tuần qua với sự nỗ lực cao của cả hệ thống chính trị thì đã đem lại kết quả tích cực.
                    ...
                    Tiếp tục thực hiện nghiêm các biện pháp giảm mật độ giao thông với các nhóm đối tượng, thời gian đã được quy định cụ thể trước đó.</p>
            </article>
            <aside class="sidebar">
                <ul>
                    <li><a href="#">Nibifa ra mắt thực phẩm bảo vệ sức khoẻ Gastro NB Plus</a> </li>
                    <li><a href="#">Nibifa ra mắt thực phẩm bảo vệ sức khoẻ Gastro NB Plus</a> </li>
                    <li><a href="#">Nibifa ra mắt thực phẩm bảo vệ sức khoẻ Gastro NB Plus</a> </li>
                    <li><a href="#">Nibifa ra mắt thực phẩm bảo vệ sức khoẻ Gastro NB Plus</a> </li>
                </ul>
